...
for($meawrow=1;$meawrow<=5;$meawrow++) {
	...
	for($meawcol=11;$meawcol>=11;$meawcol--){
		echo($meawcol-$meawrow-$meawrow);
	}
	for($meawcol=10;$meawcol>=6+$meawrow;$meawcol--){
		echo($meawcol-$meawrow-$meawrow);
	}

	for($meawcol=5;$meawcol>=1+$meawrow;$meawcol--){
		echo($meawcol-$meawrow);
	}
