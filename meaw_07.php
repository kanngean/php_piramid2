...
<?php
for($meawrow=1;$meawrow<=7;$meawrow++) {
	for($meawcol=0;$meawcol<=7-$meawrow;$meawcol++) {
	echo(" ");
	}
	for($meawcol=1;$meawcol<=1;$meawcol++){
		echo($meawcol);
	}
	for($meawcol=3;$meawcol<=1+$meawrow;$meawcol++){
		echo($meawcol-1);
	}

		echo($meawrow);

	for($meawcol=$meawrow;$meawcol>=1;$meawcol--){
		echo($meawcol);
	}
